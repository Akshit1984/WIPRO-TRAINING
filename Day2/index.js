...
console.log("Sum of 5 and 10:", sum(5, 10)); // Sum of 5 and 10: 15
...
console.log(mappedArr); // [2, 4, 6, 8, 10, NaN]
...
// Some Handy functions and methods:
...
console.log(parseFloat(val)); // 0.6 it will convert string into float (give the samee)
